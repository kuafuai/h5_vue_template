...
>
<base-list
ref="supplier_list_ref"
:isPage="true"
api="supplier_info.page"
>
<template #default="{item}">
<uni-list-item
:rightText="item.supplierName?item.supplierName:item.supplierName"
title="供货商名称"
>
...
const click_1197=(
  ...
  proxy.$navigate( "/pages/add_supplier/index",false)
