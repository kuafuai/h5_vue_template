...
@success="success_9979"
selectMap="{'tenantId':'user_info_all.get_enterprise_information_list','userRole':'user_info_all.get_user_role_status_list'}"
...
const success_9979=(
  ...
  proxy.$navigate( "/pages/user_login/index",false)
