...
>
<base-register
register_type="passwd"
@success="success_7760"
selectMap="{'buinessAuthStatus':'buiness_person_all.get_auth_status_list'}"
relevanceTable="buinessPerson"
tableName="buiness_person_all"
>
...
const success_7760=(
  ...
  proxy.$navigate( "/pages/business_login/index",false)
