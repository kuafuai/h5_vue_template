...
<script>
// #ifndef APP-NVUE
import {Canvas, setCanvasCreator, dispatch} from './l-echart/canvas';
import {wrapTouch, convertTouchesToArray, devicePixelRatio ,sleep,
canIUseCanvas2d, getRect, getDeviceInfo} from './l-echart/utils';
// #endif
// #ifdef APP-NVUE
import { base64ToPath, sleep } from './l-echart/utils';
import {Echarts} from './l-echart/nvue'
// #endif
const charts = {}
const echartsObj = {}
