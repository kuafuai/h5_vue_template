<template>
  <base-wrapper>
    <base-one-show
ref="base_one_show_06a956"
firstSearchDataComment="姓名"
v-model:more_data="more_result_list"
@show_search="base_one_show_06a956_search"
list_ref="base_list_06a956"
type="more"
...
<template #list>
<base-list
ref="base_list_06a956"
:isPage="true"
:is_click="true"
api="user_info_all.page"
@check_group_change="check_group_change_3655"
>
...
const base_one_show_06a956_search = (item) => {
    proxy.$refs.base_list_06a956.refresh(item)
}

let more_result_list = ref([])

const check_group_change_3655=(
item
)=>{
  proxy.$refs.base_one_show_06a956.refresh_more(item)
