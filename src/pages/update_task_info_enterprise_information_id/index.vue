<template>
  <base-wrapper>
    <base-one-show
ref="base_one_show_3aa2f3"
firstSearchDataComment="企业名称"
@show_search="base_one_show_3aa2f3_search"
list_ref="base_list_3aa2f3"
select_text_key="enterpriseName"
select_value_key="enterpriseInformationId"
firstSearchData="enterpriseName"
>
<template #list>
<base-list
ref="base_list_3aa2f3"
:isPage="true"
...
<template #op="{item}">
<base-button
        ref="base_button_3aa2f3"
    @click="click_202(item)"
    model="base"
    type="primary"
    title="选择"
    op_param="item"
...
const base_one_show_3aa2f3_search = (item) => {
    proxy.$refs.base_list_3aa2f3.refresh(item)
}
...
item
  ...
  proxy.$refs.base_one_show_3aa2f3.refresh(item)
