...
table_model="user_info"
not_null_field="['phoneNumber', 'userName', 'projectOrganization', 'title', 'wechatNumber']"
:id="allParams.userId"
@message_fail="message_fail_7634"
dataset="user_info"
@message_success="message_success_7634"
>
...
const message_success_7634=(
item
)=>{
  proxy.$navigate( "/pages/user_info/index",true)

}
const message_fail_7634=(
item
)=>{
  proxy.$navigate( "/pages/user_perfect/index",true)
