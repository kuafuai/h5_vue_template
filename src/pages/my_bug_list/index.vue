...
<uni-list-item
:rightText="item.bugTitle?item.bugTitle:item.bugTitle"
title="标题:"
>
...
<uni-list-item
:rightText="item.priorityStatusDescription?item.priorityStatusDescription:item.bugPriority"
title="优先级:"
>

</uni-list-item>
<uni-list-item
:rightText="item.handleStatusDescription?item.handleStatusDescription:item.bugHandleStatus"
title="审核状态:"
>
...
<uni-forms-item v-show="!allParams.bugDiscoverer" label="BUG发现人" name="bugDiscoverer" >
    <base-select  v-model="form_102.bugDiscoverer" api="bug_info_all.get_user_info_list" title="BUG发现人"></base-select>
</uni-forms-item>

<uni-forms-item v-show="!allParams.bugSubmitter" label="BUG提交人" name="bugSubmitter" >
    <base-select  v-model="form_102.bugSubmitter" api="bug_info_all.get_user_info_list" title="BUG提交人"></base-select>
</uni-forms-item>

<uni-forms-item v-show="!allParams.bugHandler" label="BUG处理人" name="bugHandler" >
    <base-select  v-model="form_102.bugHandler" api="bug_info_all.get_user_info_list" title="BUG处理人"></base-select>
</uni-forms-item>

<uni-forms-item v-show="!allParams.bugTitle" label="标题" name="bugTitle" required>
    <uni-easyinput   placeholder="请输入标题" v-model="form_102.bugTitle" />
</uni-forms-item>


<uni-forms-item v-show="!allParams.bugDescription" label="描述" name="bugDescription" >
    <uni-easyinput   placeholder="请输入描述" v-model="form_102.bugDescription" />
</uni-forms-item>


<uni-forms-item v-show="!allParams.bugImage"  label="问题图片" name="bugImage" >
    <base-image-upload v-model="form_102.bugImage"  />
</uni-forms-item>

<uni-forms-item v-show="!allParams.projectInfoId" label="项目名称" name="projectInfoId" >
    <base-select  v-model="form_102.projectInfoId" api="bug_info_all.get_project_info_list" title="项目名称"></base-select>
</uni-forms-item>

<uni-forms-item  v-show="!allParams.bugDeadline" label="截止时间" name="bugDeadline" >
    <uni-datetime-picker    placeholder="请输入截止时间" v-model="form_102.bugDeadline" type="date"
                         :format="'yyyy-MM-dd'" :value-format="'yyyy-MM-dd HH:mm:ss'" />
</uni-forms-item>

<uni-forms-item v-show="!allParams.bugPriority" label="优先级" name="bugPriority" required>
    <base-select  v-model="form_102.bugPriority" api="bug_info_all.get_bug_priority_status_list" title="优先级"></base-select>
</uni-forms-item>

<uni-forms-item v-show="!allParams.bugHandleStatus" label="审核状态" name="bugHandleStatus" required>
    <base-select  v-model="form_102.bugHandleStatus" api="bug_info_all.get_bug_handle_status_list" title="审核状态"></base-select>
</uni-forms-item>

<uni-forms-item  v-show="!allParams.createdTime" label="创建时间" name="createdTime" >
    <uni-datetime-picker    placeholder="请输入创建时间" v-model="form_102.createdTime" type="date"
                         :format="'yyyy-MM-dd'" :value-format="'yyyy-MM-dd HH:mm:ss'" />
</uni-forms-item>
...
const form_102 = ref({...allParams.value});
...
const success_536=(
  ...
  proxy.$refs.bug_info_show_detail.refresh()
...
item
  ...
  proxy.$navigate( "/pages/bug_info_detail/index?bugInfoId=" + item.bugInfoId,false)
