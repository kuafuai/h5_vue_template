...
>
<login
@loginSuccess="loginSuccess_3061"
ref="login_ref"
:is_register="'true'"
login_type="passwd"
show_title="登录"
@loginFail="loginFail_3061"
register_page="/pages/register/index"
...
const loginSuccess_3061=(
item
)=>{
  proxy.$navigate( "/pages/asset_management_home/index?userId=" + item.userId,false)

}
const loginFail_3061=(
)=>{
  uni.showToast({
